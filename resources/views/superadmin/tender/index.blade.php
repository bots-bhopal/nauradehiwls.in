                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header d-flex">
                            ...
                            <a class="btn btn-sm btn-primary ml-auto" href="{{ route('superadmin.tender.create') }}"><i
                                ...
                                <tbody>
                                    @foreach ($tenders as $key => $tender)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('superadmin.tender.edit', $tender->id) }}"
                                                ...
                                                <form id="delete-form-{{ $tender->id }}"
                                                    action="{{ route('superadmin.tender.destroy', $tender->id) }}"
