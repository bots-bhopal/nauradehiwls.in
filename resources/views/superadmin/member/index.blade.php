                                ...
                                <tbody>
                                    @foreach ($members as $key=>$member)
                                        <tr>
                                            ...
                                            <td>
                                                <input data-id="{{$member->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-size="small" data-toggle="toggle" data-style="slow" data-on="Approved" data-off="Pending" {{ $member->status ? '' : 'checked' }}>
                                            </td>
