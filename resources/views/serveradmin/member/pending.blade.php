                                    ...
                                    @foreach ($pendingMember as $key=>$member)
                                        <tr>
                                            ...
                                            <td class="text-center w-25">
                                                <a href="{{ route('serveradmin.member.edit', $member->id) }}" class="btn btn-sm btn-info mt-1"><i class="nav-icon fas fa-edit" style="margin-right: 5px;"></i>{{ __('panel.member-btn-edit') }}</a>
                                                ...
                                                <form id="delete-form-{{ $member->id }}" action="{{ route('serveradmin.member.destroy', $member->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
